"""
Django settings for project_silos project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'www-data/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'project_silos.wsgi.application'
...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR / 'www-data/static'
